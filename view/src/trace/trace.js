  ...
  render() {
        ...
        h('div', { style: 'display:flex;flex-wrap:wrap;gap:12px;align-items:flex-end;' }, [
          ...
          h('div', { class: 'log-filter-group' }, [
            ...
            h('input', {
              ...
              onInput: (e) => {
                this.operationName = e.target.value
              },
              placeholder: '操作名称',
            }),
          ]),
          ...
          h('div', { class: 'log-filter-group' }, [
            ...
            h('input', {
              ...
              value: this.limit,
              onInput: (e) => {
                this.limit = parseInt(e.target.value) || 20
              },
              min: '1',
              max: '100',
              style: 'width:80px;',
            ...
            [
              h('div', { style: 'display:flex;justify-content:space-between;' }, [
                ...
                h(
                  ...
                  this.formatDuration(t.duration || 0),
                ),
              ]),
              h(
                'div',
                { style: 'font-size:12px;color:var(--text-secondary);' },
                `${t.spans?.length || 0} spans · ${this.formatTime(t.startTime)}`,
              ),
            ],
          ),
        ),
    ...
    const waterfallChart = () => {
      ...
      const minTime = Math.min(
        ...this.spans.map((s) => new Date(s.startTime).getTime()),
        Date.now(),
      )
      ...
      return h('div', { class: 'card' }, [
        h(
          ...
          `Trace: ${this.selectedTrace.traceId}`,
        ),
        h(
          'div',
